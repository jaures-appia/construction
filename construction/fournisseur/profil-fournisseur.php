	...
	<div class="container index client">
		...
		<div class="row">
			<div class="col-lg-4 offset-lg-4 mb-5 mt-2">
				<a href="modifier.php?id=<?php echo $_SESSION['id_fournisseur']; ?>" class="bold mr-3" title="modifier vos information"><i class="fa fa-edit size-3"></i></a>
		...
		<div class="row ">
			...
			<div class="col-md-5 ">
				...
				<div class="">
						...
						<p class="bold size-2"><?php echo $query['actualite']; ?></p>
					
						<p class="size-1"><i>attention ! votre actualité n'a rien avoir avec votre description. dans l'actualité, dite quels matériaux avez vous actuelement en stock, en quel quantité... et bien d'autre information sur vaut produits</i></p>
