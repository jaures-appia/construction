	...
	<div class="container ">
		<div class="row ">
			<div class="col-lg-4 offset-lg-4 col-sm-6 offset-sm-3 index connexion-client">
				<h2 class="bold text-center mt-1">Administration</h2>
				<p class="bold text-warning "><?php if($_SESSION['Success']){echo $_SESSION['conect'];}?></p>
				<form action="trait-connexion.php" method="post">
					<div class="row">
						<div class="col-12">
